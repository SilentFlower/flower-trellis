...
## [0.6.10-beta.4](https://github.com/SilentFlower/flower-trellis/compare/v0.6.10-beta.2...v0.6.10-beta.4) (2026-09-23)
...
## [0.6.10-beta.1](https://github.com/SilentFlower/flower-trellis/compare/v0.6.10-beta.0...v0.6.10-beta.1) (2026-09-17)
...
## [0.6.10-beta.0](https://github.com/SilentFlower/flower-trellis/compare/v0.6.9...v0.6.10-beta.0) (2026-09-17)


### 🧰 维护 Maintenance

* 以 `0.6.9` 正式版为基线，包含升级性能优化、Windows 更新退出与跨平台兼容修复，发布到 `beta` 通道，供持续使用 beta 的用户升级。
...
* **plugin:** 支持离线冻结未更新的外部 Plugin ([6210cfa](https://github.com/SilentFlower/flower-trellis/commit/6210cfae8d459a3e7b105043e4ecbc23d1b5bed9))

## [0.6.3](https://github.com/SilentFlower/flower-trellis/compare/v0.6.2...v0.6.3) (2026-08-28)


### ✨ 新功能 Features

* **plugin:** 对齐 RD Guide 的 Marketplace 包模型 ([e399d6e](https://github.com/SilentFlower/flower-trellis/commit/e399d6e70042256258431a4629f5efa15ba2f417))
* **plugin:** 支持在非 Trellis 项目中管理通用 Skill ([0a9cd62](https://github.com/SilentFlower/flower-trellis/commit/0a9cd62ff3cd37971f5d65ea8500e4f51ed3a280))
* **plugin:** 复用 GitLab 全局凭据 ([a3c6b16](https://github.com/SilentFlower/flower-trellis/commit/a3c6b1616b123ff0f7328ce5b2eace5eb631ae5b))
* **plugin:** 支持 Marketplace Skill 子集选择 ([6406ccb](https://github.com/SilentFlower/flower-trellis/commit/6406ccbdbe982a885069a6a4af133fc132565a1c))


### 🐛 修复 Bug Fixes

* **plugin:** 加速 GitLab RD Guide Skill 清单读取 ([8bd1eac](https://github.com/SilentFlower/flower-trellis/commit/8bd1eac86ac32680d52c6fa715ece1b4c4ba99ef))
...
* **flower:** 修正遥测上报地址并忽略上游 npm 升级提示 ([3030472](https://github.com/SilentFlower/flower-trellis/commit/303047282032270267cf3b26ffc20c13f9892324))
...
## [0.6.1-beta.3](https://github.com/SilentFlower/flower-trellis/compare/v0.6.1-beta.2...v0.6.1-beta.3) (2026-08-16)
...
## [0.6.1-beta.0](https://github.com/SilentFlower/flower-trellis/compare/v0.6.0...v0.6.1-beta.0) (2026-08-12)
...
## [0.6.0](https://github.com/SilentFlower/flower-trellis/compare/v0.5.5...v0.6.0) (2026-08-07)
...
* **check-all:** 同步判定契约与专项验证 ([f930148](https://github.com/SilentFlower/flower-trellis/commit/f930148c47b16af98290f6ce1d7a29cd2e2d72ea))
...
* **spec:** 固化能力守恒的上下文控制契约 ([dd7af55](https://github.com/SilentFlower/flower-trellis/commit/dd7af5572455e08c47259ee7a4b2a4bcbd8cdd02))
